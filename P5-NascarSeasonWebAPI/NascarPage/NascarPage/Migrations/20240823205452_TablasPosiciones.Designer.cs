...
namespace NascarPage.Migrations
{
    ...
    [Migration("20240823205452_TablasPosiciones")]
    partial class TablasPosiciones
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NascarPage.Entitys.PosicionCampeonatoRegular", b =>
                {
                    ...
                    b.HasOne("NascarPage.Entitys.Piloto", "Piloto")
                        .WithOne("PosicionRegular")
                        .HasForeignKey("NascarPage.Entitys.PosicionCampeonatoRegular", "PilotoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NascarPage.Entitys.PosicionPlayoff", b =>
                {
                    ...
                    b.HasOne("NascarPage.Entitys.Piloto", "Piloto")
                        .WithOne("PosicionPlayoff")
                        .HasForeignKey("NascarPage.Entitys.PosicionPlayoff", "PilotoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NascarPage.Entitys.Piloto", b =>
                {
                    ...
                    b.Navigation("PosicionPlayoff")
                        .IsRequired();

                    b.Navigation("PosicionRegular")
                        .IsRequired();
                });
