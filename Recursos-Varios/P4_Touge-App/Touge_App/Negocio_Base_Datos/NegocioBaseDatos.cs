    ...
    public class NegocioBaseDatos
    {
        ...
        public void InsertarRegistro()
        {
            ...
            try
            {
                ...
                negociobd.SetearParametros(aux.Circuito, "@Circuito");
                negociobd.SetearParametros(aux.PilotoA, "@DriverA");
                negociobd.SetearParametros(aux.PilotoB, "@DriverB");
                negociobd.SetearParametros(aux.Ganador, "@PilotoGanador");
                negociobd.SetearParametros(aux.Perdedor, "@PilotoPerdedor");
                negociobd.SetearParametros(aux.AutoA, "@AutoA");
                negociobd.SetearParametros(aux.AutoB, "@AutoB");
                negociobd.SetearParametros(aux.Tiempo, "@Tiempo");
                negociobd.SetearParametros(aux.Clase, "@Clase");
                negociobd.SetearParametros(aux.Clima, "@Clima");
                negociobd.SetearParametros(aux.Modalidad, "@Modalidad");
                negociobd.SetearParametros(aux.Promocion, "@Promocion");
