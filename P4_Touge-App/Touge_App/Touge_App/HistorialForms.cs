...
namespace Touge_App
{
    public partial class HistorialForms : Form
    {
        ...
        {     
            SetPlaceholderText();
            Trasparentar();
            NegocioBaseDatos negocioPilotos = new NegocioBaseDatos();
            negocioPilotos.NombrePiloto(PilotoComboBox);
            negocioPilotos.NombrePiloto(RivalComboBox);
        ...
        private void Trasparentar()
        {
            ...
            CircuitoTextBox.Parent = PanelFondo;
        ...
        private void AgregarBoton_Click(object sender, EventArgs e)
        {
            ...
            if (CircuitoTextBox.Text != "" && PilotoComboBox.Text != "" && RivalComboBox.Text != "" && AutoRival.Text != "" && AutoTextBox.Text != "" && ClaseComboBox.Text != "" && TiempoTextBox.Text != "" &&
                ClimaComboBox.Text != "" && ModalidadBox.Text != "" && (RadioButtonSi.Checked || RadioButtonNo.Checked))
            {
                NegocioBaseDatos negocioDeBaseDatos = new NegocioBaseDatos();
                Historial aux = new Historial();
                aux.Circuito = CircuitoTextBox.Text;
                ...
                aux.AutoA = AutoTextBox.Text;
                aux.AutoB = AutoRivalTextBox.Text;
        ...
        private void PilotoComboBox_Validating(object sender, CancelEventArgs e)
        {
            ...
            if (!PilotoComboBox.Items.Contains(NombreDePiloto) && NombreDePiloto!= "")
            {
                ...
                if (resultado == DialogResult.Yes)
                    ...
                    MessageBox.Show("Este resultado no afectara a este piloto si no es ingresado");
            }
        }
